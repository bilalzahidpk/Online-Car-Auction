        ...
        return (
            ...
            <h2 className="card-title mt-3 text-center">Login</h2>          
                ...
                <div className="form-group input-group">
                    ...
                    <input value={this.state.username} onChange={this.onUsernameChangeHandler} className="form-control" placeholder="Username" type="text"/>
                </div> 
                ...
                <div className="form-group input-group">
                    ...
                    <input value={this.state.password} onChange={this.onPasswordChangeHandler} className="form-control" placeholder="Password" type="password"/>
                </div> 
