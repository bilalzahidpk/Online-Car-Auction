   ...
   onChangeHandler = (event) => {
	...
	<div className="row" id="filter">
        ...
        <div className="form-group col-md-12 col-xs-3">
			...
			<div className="form-group col-md-12 col-xs-3">
                <h6><strong>Select Make</strong></h6>
				<select data-filter="model"  onChange={this.onChangeHandler} className="filter-model filter form-control">
            ...
            { this.state.car == "Honda" ?  <div className="form-group col-md-12 col-xs-3">
            <h6><strong>Select Model</strong></h6>
            ...
            <input type="text" name="price" placeholder="From"list="citynames" className={["col-sm-6 custom-select custom-select-sm",classes["price-input-1"]].join(" ")}/>
            ...
            <input type="text" name="price" placeholder="To" list="citynames" className={["col-sm-6 custom-select custom-select-sm",classes["price-input-2"]].join(" ")}/>
                <datalist id="citynames">
